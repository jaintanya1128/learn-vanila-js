...
Hence, in JavaScript, functions are first-class objects, because they can have properties and methods just like any other object.
...
/*
 - The benefit of the named function is that, in case of error, the stack trace will contain its name and can be identified.
