...
//push(): Add a new item to an array and returns the new length. The item will be added to the end of the array.
john.push('blue');
...
john.pop();
john.pop();
john.shift(); //remove from the starting point and return it
console.log(john);
...
//The splice() method adds/removes items to/from an array, and updates array. In case of remove it returns a new array of removed items
//syntax: array.splice(startingIndex, howmanyToremove, item1, ....., itemX)
